          ...
          <div id="navbar" class="navbar-collapse collapse">
            ...
            <li><a href="{{ route('about_path')}}">About</a></li>
              ...
              <li class="dropdown">
                ...
                aria-haspopup="true" aria-expanded="false">Planet <span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a href="https://laravel.com">Lararvel.com</a></li>
                  <li><a href="https://laravel.io">Laravel.io</a></li>
                  <li><a href="https://laracarte.com">Laracarte</a></li>
                  <li><a href="https://larajobs.com">Larajob</a></li>
